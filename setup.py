...
setup(
  ...
  install_requires=['setuptools','pandas','pandasql==0.7.3','Office365-REST-Python-Client',f'https://files.pythonhosted.org/packages/01/82/6abf2c0940aba29c9b5740f67cfa4f7a987f0f1977d54cc14e0b700e1b53/apsw_wheels-3.36.0.post1-cp38-cp38-win_amd64.whl','shillelagh==1.0.5']
)
